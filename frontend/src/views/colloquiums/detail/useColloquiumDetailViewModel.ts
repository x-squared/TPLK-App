...
export function useColloquiumDetailViewModel(colloqiumId: number, initialTab?: ColloquiumDetailTab) {
  ...
  return {
    ...
    draftSignatoriesPeople: general.draftSignatoriesPeople,
    setDraftSignatoriesPeople: general.setDraftSignatoriesPeople,
    ...
    completingColloqium: general.completingColloqium,
    ...
    completeColloqium: general.completeColloqium,
